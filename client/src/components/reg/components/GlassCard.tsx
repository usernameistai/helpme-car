  ...
  return (
    <>  
      <section className={twMerge(
        ...
        bg-zinc-100/10 dark:bg-zinc-900/20 backdrop-blur-sm rounded-2xl border border-cyan-400/20 shadow-xl 
        transition-all duration-200 ease-in-out min-h-56 sm:min-h-[25vh] landscape:min-h-64
      ...
      >
        ...
        <div className="absolute inset-0 rounded-2xl border border-cyan-400/30 pointer-events-none animate-pulse-glow animate-pulse hover:opacity-50" />
      </section>
    </>
  );
};
